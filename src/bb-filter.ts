                                    ...
                                    <div class="space-y-4">
                                        <div class="flex relative w-full">
                                            ...
                                            <div class="ml-3 text-sm">
                                                ...
                                                <div><input name="is" type="${this.selectedRadioFilter === 'startswith' ? 'text' : 'hidden'}" class="bb-input" value="alicia" /></div>
                                                </div>
                                        </div>
                                        <div class="flex relative w-full">
                                            ...
                                            <div class="ml-3 text-sm">
                                                ...
                                                <div><input name="is" type="${this.selectedRadioFilter === 'endswith' ? 'text' : 'hidden'}" class="bb-input" value="alicia" /></div>
                                                </div>
                                        </div>
                                        <div class="flex relative w-full">
                                            ...
                                            <div class="ml-3 text-sm">
                                                ...
                                                <div><input name="is" type="${this.selectedRadioFilter === 'contains' ? 'text' : 'hidden'}" class="bb-input" value="alicia" /></div>
                                            </div>
                                        </div>
                                        <div class="flex relative w-full">
                                            ...
                                            <div class="ml-3 text-sm">
                                                ...
                                                <div><input name="is" type="${this.selectedRadioFilter === 'notcontains' ? 'text' : 'hidden'}" class="bb-input" value="alicia" /></div>
                                                </div>
                                        </div>
                                    </div>
                                </fieldset>
